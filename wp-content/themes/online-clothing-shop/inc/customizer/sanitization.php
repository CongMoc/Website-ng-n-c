 ...
 */
function onlineclothingshop_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function onlineclothingshop_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function onlineclothingshop_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function onlineclothingshop_sanitize_float( $input ) {
 ...
 */
function onlineclothingshop_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function onlineclothingshop_sanitize_html( $html ) {
 ...
 */
function onlineclothingshop_sanitize_image( $image, $setting ) {
 ...
 */
function onlineclothingshop_sanitize_nohtml( $nohtml ) {
 ...
 */
function onlineclothingshop_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function onlineclothingshop_sanitize_range_value( $number, $setting ) {
 ...
 */
function onlineclothingshop_sanitize_select( $input, $setting ) {
 ...
 */
function onlineclothingshop_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function onlineclothingshop_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function onlineclothingshop_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
